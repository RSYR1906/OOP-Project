...
public class StudentRepository extends Repository{
    ...
    protected Function<Entity, String> formatter() {
        return student -> {
            ...
            return studentEntity.getName() + SEPARATOR
                    + studentEntity.getEmail() + SEPARATOR
                    + studentEntity.getPassword() + SEPARATOR
                    + studentEntity.getFaculty()  + SEPARATOR
    ...
    protected LineMapper<Entity> mapper() {
        return fields -> new Student(fields[0].trim(), fields[1].trim(), fields[2].trim(), fields[3].trim(), Integer.parseInt(fields[4].trim()));
    }
    ...
    public boolean saveStudent(Student student) {
        try {
            ...
            System.err.println("EntityNotFoundException occurred: " + e.getMessage());
            return false;
        }
    }
